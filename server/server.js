...
const seedDatabase = async () => {
	try {
		...
		const books = [
			...
			{ title: 'Promises from god to every man', author: 'Harper Lee', genre: 'Fiction', description: 'A powerful story of racial injustice and moral growth', price: 2500, image: 'https://m.media-amazon.com/images/I/91K8pi4-xVL._AC_UY327_FMwebp_QL65_.jpg' },
		];
